"""
Enhanced Document Processor module for orchestrating the complete OCR pipeline.
Handles different document types and coordinates various processing steps.
"""
...
from worker.types import JobStatus, DocumentType, ProcessingMode
...
class EnhancedDocumentProcessor:
    ...
    def process_document(self, job_id: str, document_path: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Run appropriate processing based on document type and mode
            if doc_type == DocumentType.IMAGE:
                self._process_image(document_path, params, results)
            elif doc_type == DocumentType.PDF:
                self._process_pdf(document_path, params, results)
            ...
            # Run additional processing steps based on parameters
            if extract_tables and (doc_type == DocumentType.PDF or doc_type == DocumentType.IMAGE):
