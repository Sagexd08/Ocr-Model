...
class Settings(BaseSettings):
    ...
    storage_type: str = Field(default="local", env="STORAGE_TYPE")  # minio, s3, local
    ...
    load_easyocr: bool = Field(default=True, env="LOAD_EASYOCR")
...
def get_settings() -> Settings:
    """Get cached settings instance. Applies test-friendly overrides during pytest or CURIO_TEST_MODE."""
    s = Settings()
    if os.getenv("CURIO_TEST_MODE", "0") == "1" or os.getenv("PYTEST_CURRENT_TEST"):
        s.database_url = "sqlite+pysqlite:///./curioscan_test.db"
